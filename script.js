...
const perguntas = [
  {
    ...
    alternativas: ["Resolver problemas e tomar decisões automaticamente.", "Substituir os seres humanos em todas as áreas do trabalho."]
  },
  {
    enunciado: "Qual é um exemplo de IA no nosso dia a dia?",
    alternativas: ["O relógio de parede.", "O Google Tradutor."]
  },
  {
    enunciado: "A IA pode melhorar a qualidade de fotos?",
    alternativas: ["Sim, ela pode ajustar brilho, contraste e remover ruídos.", "Não, ela não altera imagens."]
  }
];
